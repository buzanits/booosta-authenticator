# Abstract user authenticator module for Booosta PHP Framework

This module provides an abstract user authenticator class for PHP Booosta. This has to be
extended for implementing the user authentication process.
